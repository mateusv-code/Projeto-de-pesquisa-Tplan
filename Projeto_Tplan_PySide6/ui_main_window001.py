...
class ui_MainWindow(object):
    ...
    def plataforma(self):
        # Parte do seu código que já funciona para pegar os valores
        ...
        for i in range(len(self.lista_de_line_edits_matriz)):
            ...
            for j in range(len(self.lista_de_line_edits_matriz[i])):
                # Converte o texto para float para os cálculos
                ...
                try:
                    ...
                    return # Interrompe a função se houver um valor inválido
        ...
        soma_cotas_x_pesos = 0
        soma_pesos = 0

        global linhas, colunas, cota_plataforma
        ...
        for i in range(linhas):
            for j in range(colunas):
                ...
                # Cantos (peso 1)
                if (i == 0 and j == 0) or \
                (i == 0 and j == colunas - 1) or \
                (i == linhas - 1 and j == 0) or \
    ...
    def calcular_volumes(self):
        ...
        for i in range(self.linhas):
            ...
            for j in range(self.colunas - 1):
                h1 = valores_matriz[i][j] - cota_plataforma
                h2 = valores_matriz[i][j+1] - cota_plataforma
